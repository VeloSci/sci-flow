...
## 3. Milestones
- [x] Build the `@sci-flow/react` package with dedicated hooks and context providers.
- [x] Ensure React nodes render cleanly via Portals natively within the SVG/Canvas structure.
- [x] Build the `@sci-flow/vue` package and components.
- [x] Conduct API parity tests between React, Vue, and Vanilla environments to guarantee an identical developer experience.
